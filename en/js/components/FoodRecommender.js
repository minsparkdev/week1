/**
 * FoodRecommender Component
 * - Random food recommendation (Quick Pick)
 * - Consistent design with other modes
 */
...
class FoodRecommender extends HTMLElement {
    ...
    render() {
        this.shadowRoot.innerHTML = `
            ...
            <div class="recommender-container">
                <div class="header">
                    <span class="mode-badge">🎲 Quick Pick</span>
                    <h2 class="title">${this.hasResult ? "Today's menu has been decided!" : 'Leave it to fate and get a recommendation'}</h2>
                    <p class="subtitle">${this.hasResult ? '' : 'One click is all it takes! No more hesitation'}</p>
                </div>
                ...
                <div class="food-display">
                    ...
                    <div class="food-info">
                        ...
                        <p class="food-desc" id="food-desc">${this.hasResult && this.currentFood ? this.currentFood.desc : 'What food will it be?'}</p>
                    </div>
                </div>
    ...
    recommendFood() {
        ...
        if (btn) {
            btn.disabled = true;
            btn.innerHTML = '<span class="btn-icon">🎲</span> Picking a menu...';
        }
    ...
    finalizeRecommendation(container) {
        ...
        // Result event is only dispatched when share button is clicked
    }
