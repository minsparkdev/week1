    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="worldcup-container">
                ...
                <h2 class="vs-title">Which food appeals to you more?</h2>
    ...
    showWinner(winner) {
        this.shadowRoot.innerHTML = `
            ...
            <div class="worldcup-container winner-container">
                ...
                <p class="winner-title">Today's winning menu is...</p>
                ...
                <div class="action-buttons">
                    ...
                    <button class="action-btn secondary" id="retry-btn">🔄 Try Again</button>
                </div>
            </div>
        `;
